...
- System taxonomy, behavioural profiling, and curriculum research
...
| Model suitability testing / behavioural profiling | `cognition-mesh-test-chamber` | `llm-semantic-dataset-sorter`, `rd-engine` | Best first stop if you want contained local evaluation that maps model-host-task meshes into failure logs, negative lanes, and suitability profiles rather than leaderboard scores. |
...
| Human-AI system taxonomy / "what kind of system is this?" | `Cognition-Scale-Formal-Taxonomy` | `Janet-MCM-Core` | Taxonomy first, implementation exemplar second. |
